**How do you prevent accidental resource deletion?**<br>
...
**How do you handle provider API rate limiting?**<br>
...
**How do you recover from courrupted state file?**<br>
...
**How do you migrate state from one backend to another?**<br>
Migration steps:
...
**How do you handle state drift in production environments?**<br>
...
**How do you manage secrets securely in Terraform?**<br>
...
**How do you properly structure Terraform modules for enterprise use?**<br>
...
**What happens if you change the `terraform.backend` configuration after a state file is already created?**<br>
...
**What is the difference between `for_each` and `for` in Terraform?**<br>
...
**What happens if a resource fails halfway through a `terraform apply`?**<br>
...
**What happens if terraform plan shows no changes but infrastructure was modified outside Terraform?**<br>
...
**What’s the fastest way to rollback an Infra change in Terraform?**<br>
...
**What is the Terraform state file? How do you manage it securely in teams?**<br>
...
**Difference between `terraform refresh`, `plan` and `apply`.**<br>
...
**How do you set up backend state in S3?**<br>
...
**Difference between count and for_each.**<br>
...
**Lifecycle block for all the rules with their use cases.**<br>
...
**What happens during terraform init?**<br>
...
**What are the best practices for organizing Terraform code and managing multiple environments?**<br>
...
**What is a taint in Terraform?**<br>
...
**How do you manage Terraform provider versioning?**<br>
...
**What happens if someone manually changes infra outside of Terraform? How do you detect and fix it?**<br>
...
**How do you implement dynamic blocks in Terraform?**<br>
...
**What to do when your Terraform state file becomes too large?**<br>
...
**What are the benefits of organizing a Terraform project using modules/workspaces?**<br>
...
**How do you implement custom validation for input variables in Terraform?**<br>
...
**How do you implement cross-account resource access and provisioning in Terraform?**<br>
...
**How would you provision infra across 10 AWS regions simultaneously?**<br>
...
**Terraform plan shows destroy + recreate for a critical DB — how to prevent downtime?**<br>
...
**How do you implement effective dependency management between Terraform stacks?**<br>
...
**You need to import an existing AWS VPC into Terraform. What are the steps?**<br>
...
**Explain terraform taint vs terraform state rm.**<br>
...
**How do you manage Terraform state across workspaces.**<br>
